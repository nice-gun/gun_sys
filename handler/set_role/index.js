...
// 设置角色
hd.post('/setRole', function (req, res, next) {
  dao.writeRole({
    ...req.body
  }, function (err, vals) {
...
// 查询所有资源
hd.post('/searchRole', function (req, res, next) {
  dao.searchRole({
    ...req.body
  }, function (err, vals) {
...
// 删除资源
hd.post('/deleteRole', function (req, res, next) {
  dao.deleteRole({
    id: req.body.id
  }, function (err, vals) {
...
// 修改资源
hd.post('/editRole', function (req, res, next) {
  delete req.body.url
  dao.editRole({
    data: {
      ...req.body
